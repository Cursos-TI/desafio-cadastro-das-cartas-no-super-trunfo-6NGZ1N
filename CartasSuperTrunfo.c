...
int main(){
    ...
    int populacao1; // populaçãp do estado
    ...
    int populacao2; // populaçãp do estado
    ...
    percapita1 = (float) (populacao1 / area1); // usei o Cast para uma Conversão explicita já que temos valores inteiros e decimais
    densidade1 = (float) (pib1 / populacao1);

    percapita2 = (float) (populacao2 / area2);
    densidade2 = (float) (pib2 / populacao2);
